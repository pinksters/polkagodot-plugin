...
func _ready():
	item_container = grid_container
	item_scene = preload("res://addons/polkagodot/ui/nft_asset_list_item/nft_asset_grid_item.tscn")
...
func refresh_nfts():
	...
	# Check if NFTs are already loaded
...
func _on_nfts_fetched(nfts: Array):
	...
	var typed_nfts: Array[NFT] = []
	for nft in nfts:
		if nft is NFT:
			typed_nfts.append(nft)
